...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/shashachkaaa/ward"
    const val APP_API_URL = "https://api.github.com/repos/shashachkaaa/ward/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/shashachkaaa/ward/master/CR.md"
    const val TG_CHANNEL_URL = "https://t.me/vanguardvpn_xyz"
