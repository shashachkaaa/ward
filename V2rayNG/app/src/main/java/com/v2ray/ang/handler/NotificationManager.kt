...
object NotificationManager {
    ...
    fun buildNotification(context: Context, title: String?): NotificationCompat.Builder {
        ...
        return NotificationCompat.Builder(context, channelId)
            ...
            // Заливка акцентом - не украшение, а условие: без неё система не считает
            // уведомление годным для «живого» (hasPromotableCharacteristics требует
            // isColorizedRequested), и плашки в строке состояния не будет.
            //
            // Но и даром она не даётся. Оболочки красят акцентом сам заголовок, и на
            // сером или тёмном акценте он выцветает: в шторке рядом с чужими
            // уведомлениями, где заголовок чёрный и жирный, наше выглядит блёклым и
            // будто неактивным.
            //
            // Поэтому просим заливку только там, где она за что-то платит: когда
            // живое уведомление и вправду будет запрошено. Выключено оно или система
            // старше шестнадцатой - уведомление обычное, с обычным заголовком.
            .apply {
